  ...
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">(32)99871-7519</span>
              <a
                href="https://wa.me/5532998717519?text=Ol%C3%A1+Sou+Thayrone+Desenvolvedor+De+Software"
                className="contact__button"
              >
                Me Escreva
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Thayrone Souza</span>
              <a
        ...
        <div className="contact__content">
          <h3 className="contact__title">Descreva Seu Projeto</h3>
